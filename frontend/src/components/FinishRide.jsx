...
const FinishRide = (props) => {
    ...
    async function endRide() {
        ...
        try {
            ...
            console.error("Failed to end ride:", error.response?.data?.message || error.message);
        }
    }

    return (
        <div>
            <h5 className='p-1 text-center w-full absolute top-0' onClick={() => props.setFinishRidePanel(false)}>
